...
const MeetingsPage = ()=>{
    ...
    const deleteMeeting = api.project.deleMeeting.useMutation()
    ...
    return (
        ...
        {meetings && meetings.length === 0 && <div>No meetings here</div>}
            ...
            {meetings?.map(meeting=>(
                <li key = {meeting.id} className='flex items-center justify-between py-5 gap-x-6'>
                    ...
                    <div className='flex items-center flex-none gap-x-4'>
                        ...
                        <Button  disabled = {deleteMeeting.isPending} className = 'sm' variant='destructive' onClick={()=>deleteMeeting.mutate(
